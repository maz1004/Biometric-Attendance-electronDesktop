...
/* Optional: stop bounce/overscroll glow on some browsers */
html, body {
...
::-moz-selection {
  ...
  --color-amber-700: #b45309; /* main */
  --color-amber-800: #92400e; /* hover/active */
 ...
 ::-moz-selection {
  ...
  /* Amber (same values in dark so color doesn't change) */
